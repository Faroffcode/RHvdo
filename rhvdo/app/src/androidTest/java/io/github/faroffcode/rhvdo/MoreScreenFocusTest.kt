...
import io.github.faroffcode.rhvdo.feature.more.screens.more.MoreScreenContent
import io.github.faroffcode.rhvdo.feature.more.screens.more.MoreUiState
...
class MoreScreenFocusTest {
    ...
    private fun showMore(history: List<Video> = clips) {
        ...
        composeRule.setContent {
            RHvdoTheme { MoreScreenContent(state = state.value, onAction = {}) }
        }
    }

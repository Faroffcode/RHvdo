...
import io.github.faroffcode.rhvdo.core.common.extensions.getInitialDirectoryUri
import io.github.faroffcode.rhvdo.core.common.extensions.getMediaContentUri
import io.github.faroffcode.rhvdo.core.common.service.registerForSuspendActivityResult
...
import io.github.faroffcode.rhvdo.feature.player.extensions.OpenDocumentAtInitialUri
...
import io.github.faroffcode.rhvdo.feature.player.service.decoderServiceState
import io.github.faroffcode.rhvdo.feature.player.service.PlayerService
import io.github.faroffcode.rhvdo.feature.player.service.addSubtitleTrack
import io.github.faroffcode.rhvdo.feature.player.service.stopPlayerSession
...
import io.github.faroffcode.rhvdo.feature.player.utils.toMediaQueue
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            CompositionLocalProvider(LocalUseMaterialYouControls provides (uiState.playerPreferences?.useMaterialYouControls == true)) {
                RHvdoTheme(darkTheme = true) {
                    MediaPlayerScreen(
                        player = player,
                        decoderServiceState = decoderServiceState,
                        viewModel = viewModel,
                        playerPreferences = uiState.playerPreferences ?: return@RHvdoTheme,

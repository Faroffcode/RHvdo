package io.github.faroffcode.rhvdo.feature.videopicker.composables
...
import io.github.faroffcode.rhvdo.core.ui.components.RestorableFocusState
...
import io.github.faroffcode.rhvdo.feature.videopicker.state.SelectionManager
        ...
        LazyVerticalGrid(
            ...
            itemsIndexed(
                ...
                FolderItem(
                    ...
                    modifier = Modifier.restorableFocusItem(focusState, folder.path),
                    selected = selected,
                    isFirstItem = index == 0,
            ...
            itemsIndexed(
                ...
                VideoItem(
                    ...
                    modifier = Modifier.restorableFocusItem(focusState, video.uriString),
                    isFirstItem = index == 0,
